...
lang: fr
source_lang: en
translation_of: why-ecovadis-strengthens-sustainability-management
title: "Au-delà de la demande d'un grand compte, pourquoi se lancer dans EcoVadis ?"
slug: pourquoi-se-lancer-dans-ecovadis
summary: >-
  EcoVadis est plus qu'une notation : c'est un parcours structuré pour bâtir
  un système de gestion de la durabilité via le modèle
  Politiques-Actions-Résultats (pondéré 25/40/35). Le score se décompose en
  politiques (20 % + 5 % d'adhésions), mesures (24 %), certifications (16 %),
  un multiplicateur de couverture, le reporting (14 %) et la Veille 360°
...
ecovadis_questions: []
keywords: [pourquoi EcoVadis, système de gestion de la durabilité, modèle P-A-R, politiques actions résultats, pondération score EcoVadis, ISO 26000, courbe de maturité, plan d'actions correctives, fusionner documents EcoVadis]
...
faq:
  - q: "Une petite entreprise peut-elle passer l'évaluation EcoVadis ?"
    a: "Oui. La classification EcoVadis commence à « très petite » (XS), et des entreprises de 7 salariés ont déjà participé avec succès."
  - q: "Peut-on fusionner des documents sur EcoVadis ?"
    a: "EcoVadis n'accepte plus les documents fusionnés, sauf les certifications de sites différents et les supports de formation combinés aux listes de présence — ce qui rend la limite annuelle de 55 documents plus difficile à gérer."
  - q: "Comment l'actualité influence-t-elle le score EcoVadis ?"
    a: "La Veille 360° scanne les sources internet à la recherche d'actualités pertinentes. Une actualité négative peut réduire le score et l'éligibilité aux médailles pendant plusieurs années ; une actualité positive vérifiée et alignée sur les thèmes peut améliorer le résultat."
  - q: "Le reporting externe est-il obligatoire pour les scores élevés ?"
    a: "Oui. Impossible de dépasser 50 % sur la section reporting sans un rapport de durabilité publié en externe, conforme à des standards comme GRI ou ESRS, ou audité en externe."
---

# Au-delà de la demande d'un grand compte, pourquoi se lancer dans EcoVadis ?

## En bref

> « EcoVadis va au-delà d'une simple notation. C'est un parcours structuré qui permet aux organisations de faire progresser en continu leur gestion de la durabilité, par des politiques claires, des actions concrètes et des résultats transparents. »
...
- **Politiques (25 %) :** les fondations — engagements qualitatifs, objectifs SMART mesurables, adhésions publiques.
- **Actions (40 %) :** les étapes tangibles — formations, certifications, mesures déployées dans les entités.
- **Résultats (35 %) :** le suivi des KPI, le reporting interne et externe, le retour des parties prenantes (dont la Veille 360°).

Le processus est itératif — chaque catégorie renforce les autres : les politiques donnent le ton de ce que vos KPI doivent chercher ; les objectifs déterminent le nombre d'actions nécessaires ; le reporting reflète si les actions suffisent ; les KPI révèlent si les objectifs sont trop timides ou trop ambitieux.
...
- EcoVadis est un plan de gestion, pas seulement une notation : P-A-R pondéré 25/40/35, adapté au secteur, à la taille et à la localisation.
- Connaître l'anatomie du score : politiques 20 % (+5 % adhésions), mesures 24 %, certifications 16 %, rapports 14 %, Veille 360° 21 %, le tout modulé par la couverture.
- Partez de votre niveau sur la courbe de maturité — du tableau KPI Excel au Bronze jusqu'à la double matérialité et aux KPI vérifiés au Platine.
- Le plan d'actions correctives, filtré par pondération, est votre feuille de route priorisée.
