...
lang: fr
source_lang: en
translation_of: ecovadis-methodology-updates-q2-2026
title: "Quelles sont les évolutions méthodologiques récentes d'EcoVadis ? Mises à jour T2 2026"
slug: evolutions-methodologiques-t2-2026
summary: >-
  Quatre mises à jour méthodologiques au T2 2026 : les objectifs de réduction
  Scope 2 doivent préciser la méthodologie market-based ou location-based
  (10 juillet) ; le Select Check Up et la consultation Score Drop pour Select
  sont supprimés, remplacés par un contrôle d'erreurs factuelles de deux jours
  avant publication (15 juillet) ; de nouveaux points d'amélioration plus
...
keywords: [mise à jour méthodologie EcoVadis 2026, Scope 2 market-based location-based, suppression Select Check Up, contrôle erreurs factuelles, points d'amélioration, risque pays, Carbon Rating, GHG Protocol]
...
faq:
  - q: "Les nouvelles options d'objectif Scope 2 changent-elles mon score ?"
    a: "Non. La mise à jour impose de sélectionner la méthodologie (market-based ou location-based) derrière un objectif absolu de réduction Scope 2, mais rien ne change dans la notation ni dans la génération des forces et points d'amélioration."
  - q: "Qu'est-ce qui remplace le Select Check Up ?"
    a: "Un contrôle d'erreurs factuelles pour tous : les résultats de la fiche d'évaluation sont visibles exclusivement par l'entreprise évaluée pendant deux jours ouvrables avant la publication sur le réseau, période pendant laquelle les erreurs factuelles peuvent être signalées."
---

# Quelles sont les évolutions méthodologiques récentes d'EcoVadis ? Mises à jour T2 2026
...
EcoVadis supprime le Select Check Up (relances en cas de documents corrompus ou de certificats déclarés sans preuve jointe) et la consultation Score Drop pour les entreprises Select de moins de 50 000 employés. La consultation Score Drop **au-delà de 50 000 employés est maintenue**.
...
Les ajustements liés aux conflits touchent des données thématiques pour l'Iran, la Libye et la Papouasie-Nouvelle-Guinée — **sans impact sur les scores**. Les ajustements de risque carbone modifient le niveau de risque global de certains pays — **ce qui peut changer les scores** des entreprises implantées dans :

| Pays | Janvier 2026 | Août 2026 |
|---|---|---|
| Costa Rica | Faible | Moyen |
| Ghana | Élevé | Moyen |
| Guyana | Élevé | Moyen |
| Indonésie | Élevé | Moyen |
| Paraguay | Moyen | Élevé |
| Pologne | Moyen | Faible |
| Seychelles | Moyen | Faible |
| Afrique du Sud | Élevé | Moyen |
| Timor-Leste | Moyen | Élevé |
| Turquie | Élevé | Moyen |
