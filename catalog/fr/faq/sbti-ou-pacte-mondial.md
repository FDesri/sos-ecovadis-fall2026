...
title: "Lequel vaut le plus : le SBTi ou l'adhésion au Pacte mondial ?"
slug: sbti-ou-pacte-mondial
summary: >-
  Le SBTi est généralement le signal le plus fort pour l'Environnement — un
  objectif validé est une preuve de haute qualité d'engagement GES quantitatif
  qui renforce aussi les Mesures. L'UNGC avec une COP substantielle contribue
  sur plusieurs thèmes. Les deux se cumulent, fréquemment chez les Or et
  Platine.
description: "Le SBTi est le signal le plus fort pour l'Environnement ; le Pacte mondial couvre plus large mais pèse moins sur un seul thème."
situations: [S1, S2, S3]
sizes: [XS, S]
...
ecovadis_questions: []
keywords: [SBTi vs UNGC, adhésions, objectif validé, COP]
