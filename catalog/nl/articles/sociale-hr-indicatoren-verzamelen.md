...
title: "Welke HR- en sociale gegevens moet u verzamelen voor EcoVadis?"
slug: sociale-hr-indicatoren-verzamelen
summary: >-
  Het EcoVadis-thema Arbeids- en Mensenrechten beoordeelt zeven criteria via
  het model Beleid-Acties-Resultaten (P-A-R). Aan de resultatenkant komen vijf
  HR-indicatoren systematisch terug: gewerkte uren, verloren dagen door
  arbeidsongeval of -ziekte, aantal arbeidsongevallen, opleidingsuren per
  medewerker en het percentage vrouwen. In België leveren het jaarverslag van
...
keywords: [EcoVadis sociale indicatoren, HR-gegevens verzamelen, rapportering arbeids- en mensenrechten, opleidingsuren, arbeidsongevallen, frequentiegraad, ernstgraad, percentage vrouwen, jaarverslag IDPBW, sociale balans, kmo, mkb]
...
faq:
  - q: "Waar vindt u die cijfers in een Belgische kmo?"
    a: "Het jaarverslag van de interne dienst voor preventie en bescherming op het werk (Formulier A) levert de gewerkte uren, de ongevallen en de verloren dagen; het jaarlijkse opleidingsplan geeft de opleidingsuren; het personeelsregister geeft het personeelsbestand en de man-vrouwverdeling."
  - q: "Wat als een indicator verslechtert van het ene jaar op het andere?"
    a: "Verberg het niet: EcoVadis kijkt naar de trend. Bereid een bewijsfiche voor met een verklarend narratief (bijvoorbeeld één ongeval met langdurige ongeschiktheid dat de verloren dagen opdrijft) — beter dan een ontbrekend of inconsistent cijfer."
---

# Welke HR- en sociale gegevens moet u verzamelen voor EcoVadis?
...
3. **Competentieontwikkeling** (opleiding, loopbaanbeheer)
4. **Diversiteit, gelijkheid en inclusie** (antidiscriminatie, gendergelijkheid)
5. **Vakbondsrechten en sociaal overleg** (vrijheid van vereniging, collectieve overeenkomsten)
...
|---|---|---|---|
| Gewerkte uren | 37.331 | **35.862** | Jaarverslag preventiedienst — Formulier A, 2025 (§2.1) |
| Verloren dagen (arbeidsgebonden letsel/overlijden/ziekte) | 192 | **245** | idem, §2.2 (verloren kalenderdagen) |
| Arbeidsongevallen | 3 | **1** | idem, §2.2 (1 ongeval met blijvende ongeschiktheid) |
...
- Vijf HR-indicatoren volstaan om de rapportering van dit thema voor een kmo te dekken: gewerkte uren, verloren dagen, ongevallen, opleidingsuren per medewerker, % vrouwen.
- De standaard Belgische bronnen bestaan al: jaarverslag van de preventiedienst (Formulier A), opleidingsplan, personeelsregister.
- Leg de perimeters één keer vast (uitzendkrachten meegeteld of niet, uren per opleidingsdag) en houd u er elk jaar aan.
- Documenteer ongunstige trends met een narratief: consistentie en verklaring tellen evenzeer als de waarde.
