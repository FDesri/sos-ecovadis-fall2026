...
title: "Hoe dragen uw emissie-inspanningen bij aan uw EcoVadis-score? De fundamenten van de CO₂-nulmeting"
slug: ecovadis-en-co2-nulmeting
summary: >-
  Binnen het thema Milieu is energieverbruik en broeikasgassen het criterium
  dat kopers het strengst bekijken, beoordeeld via Beleid-Acties-Resultaten.
  Een CO₂-nulmeting — gekwantificeerde Scope 1- en 2-emissies (sinds 2026 met
  Scope 2 zowel location-based als market-based), idealiter uitgebreid naar de
...
keywords: [CO₂-nulmeting EcoVadis, Scope 1 Scope 2 emissies, market-based location-based, CO₂-voetafdruk kmo, GHG Protocol, Milieuscore verbeteren, CSRD ESRS E1, SBTi, CDP, mkb, broeikasgasemissies]
...
faq:
  - q: "Welke broeikasgasdata vraagt EcoVadis?"
    a: "Of u uw emissies meet, welke scopes u dekt en of u reductiedoelen hebt. Scope 1- en 2-rapportering wordt van de meeste beoordeelde ondernemingen verwacht; een update van 2026 vereist Scope 2 zowel location-based als market-based waar van toepassing; materiële Scope 3-categorieën versterken de score verder."
  - q: "Heb ik een consultant nodig voor een CO₂-nulmeting?"
    a: "Niet per se voor een kleinere onderneming met eenvoudige activiteiten. Met meerdere sites, complexe ketens of zonder bestaande data bespaart gespecialiseerde hulp tijd en verkleint ze het risico op fouten die tot herindiening leiden. De nulmeting moet verdedigbaar zijn, niet alleen gedocumenteerd."
  - q: "Onze Milieuscore is laag. Waar beginnen we?"
    a: "Bij de CO₂-nulmeting. Een lage Milieuscore weerspiegelt meestal beperkt bewijs van Acties en Resultaten rond het beheer van broeikasgassen, geen fundamenteel prestatieprobleem. Meet Scope 1 en 2, documenteer het proces, stel een intern reductiedoel."
  - q: "Dient de nulmeting ook voor de CSRD?"
    a: "Ja. ESRS E1 vereist Scope 1-, 2- en 3-rapportering; de datastructuur die u voor EcoVadis bouwt, is hetzelfde fundament — één troef met dubbel gebruik in plaats van twee aparte oefeningen."
---

# Hoe dragen uw emissie-inspanningen bij aan uw EcoVadis-score? De fundamenten van de CO₂-nulmeting

## In het kort

**Expertinzicht — François Dequenne:** begin met uw CO₂-nulmeting. In de meeste gevallen weerspiegelt een lage Milieuscore beperkt bewijs van Acties en Resultaten rond het beheer van broeikasgassen, geen fundamenteel prestatieprobleem. Meet uw Scope 1- en Scope 2-emissies, documenteer het proces en stel een intern reductiedoel. Die ene ingreep doet de naald doorgaans meer bewegen dan eender welke andere.
...
- **Scope 1** — directe emissies uit bronnen die u bezit of controleert: gasketels, bedrijfsvoertuigen, processen op de site. Doorgaans het eenvoudigst te meten.
- **Scope 2** — indirecte emissies van aangekochte elektriciteit, warmte of stoom. Sinds 2026 vraagt EcoVadis rapportering **location-based ÉN market-based**; hernieuwbare certificaten (garanties van oorsprong) verlagen het market-based cijfer, maar beide moeten gedocumenteerd zijn.
- **Scope 3** — al de rest van de waardeketen: aangekochte goederen en diensten, woon-werkverkeer, zakenreizen, distributie, afval, gebruik van verkochte producten. Doorgaans het overgrote deel van de voetafdruk van een producent.
