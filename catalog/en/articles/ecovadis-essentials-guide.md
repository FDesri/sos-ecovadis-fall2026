...
source_lang: en
translation_of: null
title: "What are the most useful EcoVadis tips? The essentials for beginners and reassessed companies"
slug: ecovadis-essentials-guide
summary: >-
  A two-track cheat sheet. Foundation track (first-timers): nine steps from
  understanding your tailored questionnaire to submission — assign theme
  owners, self-audit evidence (2 years for KPIs, 8 for policies), match
  documents to Policies-Actions-Results, use clear file names, comments and
  page numbers. Acceleration track (reassessment): five steps — quick wins
  from rejected documents, the corrective action plan sorted by weight,
  meaningful change over box-ticking, explanatory comments, and a precise
  reading of every question.
description: "A two-track EcoVadis cheat sheet: nine steps for a first assessment, and the route to follow when you are being reassessed."
situations: [S1, S2, S3]
sizes: [XS, S]
...
ecovadis_questions: []
keywords: [EcoVadis tips, first EcoVadis assessment, EcoVadis reassessment, evidence self-audit, document naming, corrective action plan, rejected documents, EcoVadis cheat sheet, 55 documents]
...
faq:
  - q: "How long before submission should you start preparing?"
    a: "Around three months, with the effort spread across the team. Last-minute scrambles are the top cause of avoidable errors."
  - q: "How recent must evidence be?"
    a: "KPIs: no older than 2 years. Policies and procedures: no older than 8 years. Every document needs a logo or company name and a date."
---
...
- Balance Policies, Actions and Results — good intentions alone don't score.
- Self-audit evidence before submitting: recent, branded, company-specific, correctly scoped.
- Start three months ahead, keep a live evidence folder, and involve senior management.
- At reassessment: quick wins from rejected documents first, then the CAP sorted by weight, then meaningful change.
- Comments and page numbers are free points: they steer the analyst to your evidence.
