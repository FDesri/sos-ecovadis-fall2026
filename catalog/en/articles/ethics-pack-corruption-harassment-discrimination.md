...
title: "Anti-corruption, harassment and discrimination pack: simple small actions for a Belgian SME"
slug: ethics-pack-corruption-harassment-discrimination
summary: >-
  A very "Belgian SME / EcoVadis" selection of simple, credible, documentable
  actions: ten anti-corruption actions (gifts register, supplier clause,
  conflict-of-interest declarations, mini-training, reporting channel…) and
  ten harassment/discrimination actions (zero-tolerance communication,
  contact person, recruitment checklist, respect-at-work toolbox…), each
  with its EcoVadis evidence. Everything assembles into a single 10-15 page
  PDF file that demonstrates operational implementation — communication,
...
keywords: [SME anti-corruption, gifts register, supplier anti-corruption clause, workplace harassment, discrimination, confidential counsellor, whistleblowing channel, respect at work toolbox, EcoVadis evidence pack]
...
faq:
  - q: "Which anti-corruption actions pay off most for EcoVadis?"
    a: "Five: the gifts and invitations register, the supplier anti-corruption clause, the annual mini-training with attendance sheet, the new supplier/intermediary checklist, and a simple, communicated reporting channel."
  - q: "Does an SME with fewer than 50 workers need a whistleblowing channel?"
    a: "In Belgium, the internal whistleblowing channel is mandatory from 50 workers; below that threshold it remains voluntary (except specific sectors) — but it is excellent ESG evidence. Same logic for the confidential counsellor: mandatory from 50 workers, optional below."
  - q: "How should this evidence be presented to EcoVadis?"
    a: "As a single 10-15 page PDF: signed management commitment, gift rules, registers, supplier clause, reporting procedure, communications, training with attendance, and simple indicators. It demonstrates operational implementation, not intention."
---
...
- Twenty small actions, each with its evidence: the effort counts in hours, the credibility in years.
- The 5 most profitable anti-corruption proofs: gifts register, supplier clause, mini-training, third-party checklist, reporting channel.
- Belgian thresholds: whistleblowing channel and confidential counsellor mandatory from 50 workers — voluntary but valuable below.
- A single 10-15 page PDF assembles everything into proof of operational implementation.
- Simple indicators (trained, reports, corrective actions) turn actions into Results.
