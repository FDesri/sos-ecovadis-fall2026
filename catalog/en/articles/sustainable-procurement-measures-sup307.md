...
summary: >-
  ...
  tick what can be proven by a dedicated document — a ticked option without
  evidence is neutralised by the assessor and weakens the whole section. An
  anonymised real case (Walloon flexographic printer, size S) shows 5 of 9
  options to tick, two quick wins (buyer toolbox, SP objective in a
...
keywords: [SUP307, EcoVadis sustainable procurement, supplier code of conduct, CSR contract clauses, supplier risk assessment, supplier questionnaire, buyer training, supplier audits, SUP600, due diligence]
...
faq:
  ...
  - q: "Can the supplier code of conduct be the same document as the sustainable procurement policy?"
    a: "No. EcoVadis expects two distinct documents: the code of conduct is external (addressed to suppliers), the sustainable procurement policy is internal (addressed to the procurement team). Each serves a different purpose."
  - q: "Should you tick option 9, 'Other actions'?"
...
- Only tick the provable: an option without dedicated evidence is neutralised and weakens the whole section.
- A supplier-signed code counts double: actual communication (option 1) and contractual value (option 2).
- Split large PDFs into targeted uploads per option — the assessor must find the evidence immediately.
- Two recurring quick wins: the buyer toolbox (option 5) and an SP objective in a signed review (option 7).
- Keep the KPIs for SUP600, but copy the sanction rule into SUP307's contract clause.
