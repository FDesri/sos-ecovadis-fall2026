...
title: "Diversity, corruption, child labour: what to answer when \"none of that happens here\" (templates)"
slug: evidence-templates-diversity-corruption-child-labour
summary: >-
  Four subjects Belgian SMEs believe are "not applicable" — diversity and
  non-discrimination, corruption risk, social reporting, prevention of child
  and forced labour — are in fact documentable with simple evidence: an
  objective recruitment grid, a gifts register, an HR dashboard, a hiring
  checklist. Even "0 cases" can be reported if the channel exists and is
  monitored. The article provides useful evidence per subject, five
...
keywords: [diversity non-discrimination EcoVadis, corruption risk SME, gifts register, conflicts of interest, social reporting, Belgian social balance sheet, child labour, forced labour, young workers, evidence templates]
...
faq:
  - q: "There is no discrimination or corruption in our company — do we still have to answer these questions?"
    a: "Yes. EcoVadis assesses the management system, not the existence of incidents. Even '0 cases' can be reported, provided the reporting channel exists and is monitored in a register. A company with no documented evidence is scored as a company with no management."
  - q: "What is the most common mistake on these subjects?"
    a: "Declaration without evidence: 'we are an inclusive company', a generic charter never deployed, or unnecessary personal data. Every file must show company name, date, scope, owner, action taken and proof of execution."
  - q: "How valuable is the Belgian social balance sheet as EcoVadis evidence?"
    a: "Very: it is part of the annual accounts of the companies concerned and contains headcount, staff movements and training — exactly the KPIs expected in social reporting, with units and period."
---

# Diversity, corruption, child labour: what to answer when "none of that happens here" (templates)
...
- "Nothing to report" is not an answer: EcoVadis scores the management system, and "0 cases" is reportable if the channel exists and is monitored.
- The expected evidence is modest: recruitment grid, gifts register, hiring checklist, HR dashboard.
- The Belgian social balance sheet is ready-made reporting evidence for the companies concerned.
- A declaration without evidence, an undeployed charter or unnecessary personal data hurt the file.
- Five templates standardise evidence production — the effort counts in hours, not weeks.
