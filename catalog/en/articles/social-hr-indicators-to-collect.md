...
lang: en
source_lang: fr
translation_of: indicateurs-sociaux-rh-a-collecter
title: "Which HR and social data do you need to collect for EcoVadis?"
slug: social-hr-indicators-to-collect
summary: >-
  The EcoVadis Labor & Human Rights theme assesses seven criteria through the
  Policies-Actions-Results model. On the results side, five HR indicators come
  up systematically: hours worked, days lost to work-related injury or
  illness, number of workplace accidents, training hours per employee, and
  percentage of women. In Belgium, the internal prevention service's annual
  report and the training plan provide most of it — the work is settling
  scopes (temporary workers in or out) and documenting unfavourable trends
  before reassessment.
description: "Hours worked, days lost, training, diversity: the five HR indicators the Labor & Human Rights theme systematically expects to see."
situations: [S1, S2]
sizes: [S]
...
keywords: [EcoVadis social indicators, HR data to collect, labor and human rights reporting, training hours, workplace accidents, frequency rate, severity rate, percentage of women, social report]
...
faq:
  - q: "Where do you find these figures in a Belgian SME?"
    a: "The internal prevention and protection service's annual report (Form A) provides hours worked, accidents and days lost; the annual training plan gives training hours; the staff register gives headcount and the gender split."
  - q: "What if an indicator deteriorates from one year to the next?"
    a: "Do not hide it: EcoVadis looks at the trend. Prepare an evidence sheet with a narrative explaining the gap (for instance a single accident with long-term incapacity inflating days lost) — better than a missing or inconsistent figure."
---

# Which HR and social data do you need to collect for EcoVadis?
...
3. **Skills development** (training, career management)
4. **Diversity, equity and inclusion** (anti-discrimination, gender equality)
5. **Union rights and social dialogue** (freedom of association, collective agreements)
...
|---|---|---|---|
| Hours worked | 37,331 | **35,862** | Prevention service annual report — Form A, 2025 (§2.1) |
| Days lost (work-related injury/death/illness) | 192 | **245** | idem, §2.2 (calendar days lost) |
| Workplace accidents | 3 | **1** | idem, §2.2 (1 accident with permanent incapacity) |
...
- Five HR indicators cover the theme's reporting for an SME: hours worked, days lost, accidents, training hours per employee, % of women.
- The standard Belgian sources already exist: the prevention service's annual report (Form A), the training plan, the staff register.
- Settle scopes once (temporary workers in or out, hours per training day) and stick to them every year.
- Document unfavourable trends with a narrative: consistency and explanation count as much as the value.
