...
title: "Which supporting documents can you provide when you run a very small (XS) company?"
slug: supporting-documents-for-xs-companies
summary: >-
  For XS companies (up to 25 employees), EcoVadis asks about ten questions on
  average, deactivates certain indicators (endorsements, coverage) and accepts
  less formalised supporting documents. Still mandatory: recent, relevant,
  complete documents tied to the assessment scope, carrying the company
  name/logo and a date (8-year validity for policies and actions, 2 years for
...
ecovadis_questions: []
keywords: [XS supporting documents, very small company EcoVadis, EcoVadis evidence small business, accepted documents EcoVadis, rejected documents, document validity, XS guide]
audience: [sme_owner]
...
faq:
  - q: "Can an energy invoice serve as reporting evidence?"
    a: "No. Third-party utility invoices are not admissible for Reporting: that indicator assesses active tracking and progress benchmarking of KPIs, not the mere availability of information. An invoice can, however, prove a measure (the purchase of energy-efficient equipment, for instance)."
  - q: "How many questions does an XS company get?"
    a: "About ten on average. The questionnaire is tailored to sector, location and size, and some indicators such as endorsements (UN Global Compact) and coverage do not apply to XS companies."
---
...
- relevant, complete and tied to the corresponding assessment scope;
- in an accepted format (.pdf, .docx, .xlsx, .png…) and under 30 MB;
- regularly reviewed: validity of **8 years for policies and actions**, **2 years for KPI reporting**;
- in text form: documents not written in English, French, Spanish, German, Chinese or Japanese should be submitted as encoded text, not images;
- for a web link: only the linked page is captured as a PDF, not the whole site.
...
- An XS company gets ±10 questions, without endorsements or coverage: the questionnaire is proportionate.
- XS flexibility concerns form, not substance: recent, relevant, complete, in scope, with name/logo and date.
- Validity: 8 years (policies, actions), 2 years (KPI reporting).
- An invoice proves a measure, never reporting: reporting requires active KPI tracking in an official document.
- The winning reflex: lightly formalise what already exists (a signed letter, an Excel table, e-mails) rather than creating documents for the occasion — those get rejected.
