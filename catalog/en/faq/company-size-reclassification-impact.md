...
source_lang: en
translation_of: null
title: "What happens when EcoVadis reclassifies our company size — and can we prevent it?"
slug: company-size-reclassification-impact
summary: >-
  Reclassification is automatic, based on FTE counts from public information
  and your own data, and cannot be prevented. The questionnaire then changes:
  more criteria activate and standards rise — a 71/100 SME can fall below
...
ecovadis_questions: []
keywords: [size reclassification, XS to S, FTE count, 71 below Silver]
...
Practical approach: build the expanded requirements into your improvement planning and address newly activating criteria **before** the next submission. If you believe EcoVadis has applied an incorrect employee count, raise this through the support portal before opening the questionnaire.
