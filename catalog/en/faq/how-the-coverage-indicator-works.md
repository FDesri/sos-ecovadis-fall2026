...
source_lang: en
translation_of: null
title: "How does the Coverage indicator work — and how do we manage the KPI/Coverage trade-off?"
slug: how-the-coverage-indicator-works
summary: >-
  Coverage (large companies, 1,000+ employees) multiplies the Measures and
  Certifications scores (minimum threshold 25) and rewards breadth of
  deployment. A new KPI covering under 50% of scope can lower Coverage even
  while improving Reporting — declare KPIs only when deployment exceeds 50%;
  two assured proxy KPIs above 50% can reach 100/100 per pillar. To lift
...
topics: [methodologie]
ecovadis_questions: []
keywords: [Coverage indicator, multiplying factor, 50% coverage, 1000 employees, proxy KPIs]
