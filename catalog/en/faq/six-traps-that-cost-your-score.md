...
source_lang: en
translation_of: null
title: "What are the key traps to avoid in an EcoVadis assessment?"
slug: six-traps-that-cost-your-score
summary: >-
  Six traps consistently cost points: expired documents; evidence without
  affiliation to the assessed entity; ignoring weak themes (each theme needs a
...
ecovadis_questions: []
keywords: [EcoVadis traps, 30 per theme, expired documents, 360 Watch, Coverage]
...
# What are the key traps to avoid in an EcoVadis assessment?

Six traps consistently cost companies score:

1. **Submitting expired documents** — anything with a validity date that has passed.
2. **Uploading evidence without any affiliation** to the assessed entity (no name or logo).
